...
class HistoriqueState extends State<Historique> {
  ...
  void initState() {
    ...
    setState(() {
      avionHistorique = false;
      bateauHistorique = false;
      voitureHistorique = false;
    });
  }
  ...
  void _filterClients(String status) {
    setState(() {
      EasyLoading.show();
      filtrerListeColisTypeEnvoiEtTelephone =
          listeTotalColisEnregistrer.where((client) {
        bool matchesPhone = client['vcMsisdnSender']
                ?.toLowerCase()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: entePage(
            context,
            const AccueilPage(),
            "Historique des colis enregistrés",
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Text(
                  "Liste des colis qui ont été enregistrés",
                  style: TextStyle(
                                  ...
                                  onTap: () {
                                    monModal.showBottomSheet(
                                        ...
                                        contenuModal(
                                          ...
                                          poids:filtrerListeColisTypeEnvoiEtTelephone[index]['iPoid'],
            ...
            child: InkWell(
              onTap: () {
                setState(() {
                  ...
                  avionHistorique = false;
                  bateauHistorique = false;
                  voitureHistorique = true;
                });
              },
              child: Container(
                height: 40,
                decoration: BoxDecoration(
                  color: voitureHistorique
                      ? Coleur().couleurE0E0E0
                      : Coleur().couleurWhite,
                  border: Border.all(color: Colors.black, width: 0.5),
                ),
  ...
  Widget contenuModal({
    ...
    return Column(
      children: [
        ...
        }, "Fermer", Coleur().couleur114521, Coleur().couleurWhite, 2, 48, 70,
            0.5)
